...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $data['PreBinaryCommission'] = isset($PreBinaryCommission) ? $PreBinaryCommission->amount : 0;
        $data['PreAgencyCommission'] = isset($PreAgencyCommission) ? $PreAgencyCommission->amount : 0;
