                    ...
                    <div class="col-md-6">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title">{{ trans('adminlte_lang::profile.security_settings') }}</h4>
                                    <form class="" id="formchangpassword" _lpchecked="1">
                                        <div class="row" change-password>
                                            <h4 class="col-md-12">{{ trans('adminlte_lang::profile.change_password') }}<div class="card-control"><a href="javascript:;" edit-change-password>Edit</a></div></h4>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group label-floating">
                                                    <label class="control-label">{{ trans("adminlte_lang::profile.old_password") }}</label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group label-floating">
                                                    <label class="control-label">{{ trans("adminlte_lang::profile.new_password") }}</label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group label-floating">
                                                    <label class="control-label">{{ trans("adminlte_lang::profile.confirm_password") }}</label>
                                            ...
                                            <div class="col-md-12">
                                                <div class="pull-right" btn-action-change-password style="display: none;">
                                                    <button type="button" class="btn btn-primary btn-round" id="savePassword">{{ trans('adminlte_lang::profile.btn_save') }}</button>
                                        ...
                                        <div class="row" authentication>
                                            <div class="col-md-12 d-flex my-3 justify-content-between">
                                                <div class="togglebutton">
                                                    <label class="h4" style="color: rgba(0, 0, 0, 0.87)">{{ trans('adminlte_lang::profile.two_factor_authen') }}
                                                        <input type="checkbox" class="ml-4" 2factorAuthentication id="switchAuthen" {{ Auth::user()->is2fa ? 'checked' : '' }}>
                                                    </label>
                                                </div>
