	                				...
	                				<table class="table no-footer" id="referrals-grid" role="grid" aria-describedby="employee-grid_info">
	                					...
	                					<tbody>
											...
											<tr>
												...
												<td><a href="{{ URL::to('week/tickets/level/3/w/'). '/' . $binary->week_year }}">{{ number_format($binary->level_3, 2) }}</a></td>
												<td><a href="{{ URL::to('week/tickets/level/4/w/'). '/' . $binary->week_year }}">{{ number_format($binary->level_4, 2) }}</a></td>
												<td><a href="{{ URL::to('week/tickets/level/5/w/'). '/' . $binary->week_year }}">{{ number_format($binary->level_5, 2) }}</a></td>
