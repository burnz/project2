                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="card card-stats">
                            ...
                            <div class="card-content">
                                ...
                                <h4 class="card-title"><img src="assets/img/ic_zcoin-pri.svg" style="width: 24px"> 3,721</h4>
                            </div>
                            <div class="card-footer">
                                <div class="stats">
                                    <i class="material-icons">update</i> Just Updated
                        ...
                        <form method="#" action="regular.html#">
                            ...
                            <div class="input-group form-group">
                                <span class="input-group-addon">
                                    <img src="assets/img/bitcoin-symbol.svg" style="width: 24px;">
                                </span>
                            ...
                            <div class="input-group form-group">
                                <span class="input-group-addon">
                                    <img src="assets/img/ic_zcoin-pri.svg" style="width: 24px;">
                                </span>
                                <div class="form-group label-floating">
