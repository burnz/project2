$(document).ready(function() {
    ...
    window.iOS11 = /OS 11|OS 12/.test(ua);
    ...
    function resizeElementEqualToElement() {
        var Source = $('[source-el-height="md"]');
        var Destination = $('[destination-el-height="md"]').height();
        
        window_width > 991 ? Source.height(Destination) : Source.css('height', '');
    }
